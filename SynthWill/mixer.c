...
#include "mini_aud/extras/dr_flac.h"  /* Enables FLAC decoding. */
#define DR_MP3_IMPLEMENTATION
#include "mini_aud/extras/dr_mp3.h"   /* Enables MP3 decoding. */
#define DR_WAV_IMPLEMENTATION
#include "mini_aud/extras/dr_wav.h"   /* Enables WAV decoding. */
